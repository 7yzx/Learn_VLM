...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    dtype=None,  # None for auto detection. Float16 for Tesla T4, V100, float16 for Ampere+
...
- ```dtype = None``` – Defaults to None; use torch.float16 or torch.float16 for newer GPUs.
