    ...
    const int im2col_step)
{
    ...
    for (int n = 0; n < batch/im2col_step_; ++n)
    {
        ...
        AT_DISPATCH_FLOATING_TYPES_AND2(at::ScalarType::Half, at::ScalarType::float16, value.scalar_type(), "ms_deform_attn_forward_cuda", ([&] {
    ...
    const int im2col_step)
{
    ...
    for (int n = 0; n < batch/im2col_step_; ++n)
    {
        ...
        AT_DISPATCH_FLOATING_TYPES_AND2(at::ScalarType::Half, at::ScalarType::float16, value.scalar_type(), "ms_deform_attn_backward_cuda", ([&] {
