...
Il metodo `nn.Linear` riduce la dimensione di 2 per i pesi `float16` e `float16` e di 4 per i pesi `float32`, con un impatto quasi nullo sulla qualità, operando sugli outlier in half-precision.
