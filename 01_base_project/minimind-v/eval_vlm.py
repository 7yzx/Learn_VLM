...
def init_model(args):
    ...
    if 'model' in args.load_from:
        ...
        model.vision_encoder, model.processor = MiniMindVLM.get_vision_model("/mnt/sevenT/zixiaoy/checkpoints/openai/clip-vit-base-patch16") # debug
...
def main():
    ...
    for image_file in sorted(os.listdir(args.image_dir)):
        if image_file.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp')):
            ...
            # print(f"image: {image_file}, {image}")
